...
***** TODO Validation error styles on registrations/new match those on applications/new
***** TODO Error message at the top of registrations/new when there are validation errors
...
*** TODO Invite existing approved applicants
**** [2/3] Acceptance Criteria
***** TODO Users created/applications imported
***** DONE Course set up
